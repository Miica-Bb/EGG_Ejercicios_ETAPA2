...
public class Curso {
    ...
    public String toString() {
        return "Curso{" + "nombreCurso=" + nombreCurso + ", turno=" + turno + ", cantidadHorasPorDia=" + cantidadHorasPorDia + ", cantidadDiasPorSemana=" + cantidadDiasPorSemana + ", precioPorHora=" + precioPorHora + ", alumnos=" + Arrays.toString(alumnos) + '}';
    }    
}
